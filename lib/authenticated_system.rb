  ...
  protected
    ...
    def permission_denied
      respond_to do |format|
        format.html do
          ...
          flash[:error] = "You dont have permission to complete that action"
    ...
    def check_role(role)
      unless logged_in? && @current_user.has_role?(role)
        if logged_in?
          permission_denied # the user is logged in, however, he doesnt have permission to do that action
        else
          store_referer
          access_denied
        end
