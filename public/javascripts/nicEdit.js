...
var nicUploadButton = nicEditorAdvancedButton.extend({	
	...
	addPane : function() {
		...
		var html = '<a href="#" onclick="$(\'url_form\').hide();$(\'upload_form\').show();">Upload</a>  <a href="#" onclick="$(\'upload_form\').hide();$(\'url_form\').show();">Url</a><hr/>';		
		html += '<div id="upload_form"><form action="/upload_images" enctype="multipart/form-data" method="post" target="upload_frame">';
		html += '<label for="photo_support jpg, gif, png maxium size is 4MB">Support jpg, gif, png maxium size is 4mb</label><br>';
  		...
  		html += '<input id="photo_submit" name="commit" value="upload" type="submit">';
		html += '</form>';
		html += '<iframe id="upload_frame" name="upload_frame" style="border: 0px none ; width: 1px; height: 1px;" src="about:blank"></iframe></div>';
		html += '<div  id="url_form" style="display:none"><form id="url_form2">URL:<input id="photo_src" type="text"><input value="add" type="submit"></form></div>';
		...
		this.url_form.observe('submit', function(){
			...
			this.ne.selectedInstance = this.sss;
		...
		this.myFrame = $('upload_frame');
		this.progressWrapper = new bkElement('div').setStyle({display: 'none', width: '100%', height: '20px', border : '1px solid #ccc'}).appendTo(this.myFrame);
